      ...
      <b-row>
        ...
        >
          ...
          >
              ...
              <b-col md="12">
                <b-card-body>
                  <b-card-title class="card-title">{{
                    doctor.person.name
                  }} {{ doctor.person.surname }} {{ doctor.person.lastname }}</b-card-title>
                  <b-card-text>
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      <b>Correo: </b>
                      <span
                        v-if="doctor.person.email && doctor.person.email.length > 50"
            ...
            <template #footer>
              <div>
                <b-button class="ml-2" variant="primary"  @click="getOneDoctor(doctor.id)">
                  Mas información 
                </b-button>
              </div>
            </template>
